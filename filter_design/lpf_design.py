#This script comes from https://github.com/curiores/ArduinoTutorials/blob/main/BasicFilters/Design/LowPass/LowPassFilter.ipynb
#Writted by "Curiores"
...
# Generate a signal
samplingFreq = 10000; # sampled at 1 kHz = 1000 samples / second
